...
int main()
{
    ...
    using desc_t = boost::fusion::vector<hexapod_dart::descriptors::DutyCycle, hexapod_dart::descriptors::RotationTraj, hexapod_dart::descriptors::JointsTraj, hexapod_dart::descriptors::OrientationBD>;
    ...
    std::vector<double> v;
    simu.get_descriptor<hexapod_dart::descriptors::OrientationBD>(v);
